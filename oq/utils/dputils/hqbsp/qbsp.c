...
int main (int argc, char **argv)
{
  ...
  if (i != argc - 2 && i != argc - 1)
	  Error ("LordHavoc's improved qbsp\ncurrent features: insane limits, transparent water/slime/lava (-nowater to disable)\nemail havoc@halflife.org with feature requests/suggestions.\nusage: hqbsp [options] sourcefile [destfile]\noptions: -water -notjunc -nofill -draw -onlyents -verbose -proj <projectpath>");
  // LordHavoc: removed  -threads[124] from the usage because it did nothing
