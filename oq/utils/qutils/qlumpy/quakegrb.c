...
void GrabPic (void)
{
    ...
    // This used to require that hx<319 && yh<199 to enforce
    // a 320x200 paletted screen (VGA 13H mode).
    // That code was removed so that OpenQuartz could have help
    // screens that are 320x240, which is the size of a PocketPC's 
    // screen.
    //
