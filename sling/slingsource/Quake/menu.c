...
void M_Main_Draw (void)
{
	...
	M_DrawTransPic (54, 32 + m_main_cursor * 20,Draw_CachePic("gfx/menudot1.lmp"));
}
...
void M_SinglePlayer_Draw (void)
{
	...
	M_DrawTransPic (54, 32 + m_singleplayer_cursor * 20,Draw_CachePic("gfx/menudot1.lmp"));
}
...
void M_Quit_Draw (void) //johnfitz -- modified for new quit message
{
	...
	//sprintf(msg1, "SLING " QUAKESPASM_VER_STRING);
