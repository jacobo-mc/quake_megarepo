...
local vector bounce_vel = '0.00000 0.00000 0.00000';
   ...
   self.velocity_z = ((random () * 300.00000) + 150.00000);
...
local vector goaldir = '0.00000 0.00000 0.00000';
   ...
   newmis.nextthink = (time + 30.00000);
   newmis.think = SUB_Remove;
};


void  ()rat_stupor =  {
   self.angles_y += ((random () * 4.00000) - 2.00000);
   self.frame = (random () * 17.00000);
   self.think = rat_stupor;
   self.nextthink = ((time + (random () * 1.00000)) + 0.30000);
};
