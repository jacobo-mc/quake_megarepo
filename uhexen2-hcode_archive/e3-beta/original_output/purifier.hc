...
local entity missile;
   ...
   missile.classname = "purimissile";
   makevectors (self.v_angle);
   missile.velocity = aim (self, (((self.origin + self.proj_ofs) + (v_forward * 6.00000)) + (v_right * 10.00000)), 1000.00000);
   missile.velocity = (missile.velocity * 1000.00000);
...
void  ()pal_purifier_fire =  {
   if ( (self.hull == HULL_NORMAL) ) {
      ...
      self.think = player_paladin_crouch_attack;
