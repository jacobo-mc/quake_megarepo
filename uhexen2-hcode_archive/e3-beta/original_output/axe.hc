...
local entity missile;
   ...
   missile.velocity = aim (self, (((self.origin + self.proj_ofs) + (v_forward * 10.00000)) + (v_right * 1.00000)), 900.00000);
   ...
   setsize (missile, '-8.00000 -8.00000 0.00000', '8.00000 8.00000 0.00000');
...
local vector org = '0.00000 0.00000 0.00000';
   if ( ((self.artifact_active & ART_TOMEOFPOWER) && (self.greenmana >= 8.00000)) ) {
      ...
      launch_axe ('0.00000 -5.00000 0.00000', '0.00000 0.00000 0.00000');
      launch_axe ('5.00000 0.00000 0.00000', '0.00000 0.00000 0.00000');
      launch_axe ('-5.00000 0.00000 0.00000', '0.00000 0.00000 0.00000');
...
void  ()pal_axe_fire =  {
   ...
   if ( (self.artifact_active & ART_TOMEOFPOWER) ) {
      ...
      self.attack_finished = (time + 1.50000);
   } else {
