...
void  ()hydra_TentFrames =  {
   ...
   if ( (AdvanceFrame (192.00000, 215.00000) == AF_END) ) {
      ...
      hydra_tent (hydra_TentAttacks[self.frame - 192]);
...
void  ()hydra_SwimFrames =  {
   ...
   hydra_move (hydra_Swim[self.frame - 172]);
};
...
void  ()hydra_BigLeft =  {
   ...
   hydra_turn_left (hydra_BigTurn[self.frame - 46]);
};
...
void  ()hydra_ShortLeft =  {
   ...
   if ( (self.frame <= 56.00000) ) {
      ...
      hydra_turn_left (hydra_ShortTurn[self.frame - 46]);
   } else {

      hydra_turn_left (hydra_ShortTurn[(self.frame - 46) - 11]);
...
void  ()hydra_BigRight =  {
   ...
   hydra_turn_right (hydra_BigTurn[self.frame - 84]);
};
...
void  ()hydra_ShortRight =  {
   ...
   if ( (self.frame <= 94.00000) ) {
      ...
      hydra_turn_right (hydra_ShortTurn[self.frame - 84]);
   } else {

      hydra_turn_right (hydra_ShortTurn[(self.frame - 84) - 11]);
