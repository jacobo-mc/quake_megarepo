...
local float retval = 0.00000;
   ...
   if ( (self.monster_stage == WH_STAGE_BEGIN_REAR) ) {
      ...
      self.movechain.frame = WarRiderFrames[3] + (self.frame - 103);
   } else {
      ...
      if ( (self.monster_stage == WH_STAGE_MIDDLE_REAR) ) {
         ...
         self.movechain.frame = WarRiderFrames[4] + (self.frame - 63);
         ...
         if ( (self.monster_stage == WH_STAGE_STANDING) ) {
            ...
            self.movechain.frame = WarRiderFrames[10] + (self.frame - 0);
            if ( !self.enemy ) {
            ...
            if ( self.enemy ) {
               ...
               if (self.movechain.frame == WarRiderFrames[11]) {
                  ...
                  if (self.movechain.frame == WarRiderFrames[12]) {

                     waraxe (self.enemy, '-3.00000 3.00000 70.00000', 1.00000);
                  } else {

                     if (self.movechain.frame == WarRiderFrames[13]) {
            ...
            if ( (self.monster_stage == WH_STAGE_END_REAR) ) {
               ...
               riderpath_move (self.speed);
               self.movechain.frame = WarRiderFrames[5] + (self.frame - 119);
...
local float retval = 0.00000;
   ...
   if ( (self.monster_stage == WH_STAGE_ATTACK) ) {
      ...
      if ( (self.rider_gallop_mode == 0.00000) ) {
         ...
         self.movechain.frame = WarRiderFrames[6] + (self.frame - war_start[self.rider_gallop_mode]);
         if (self.movechain.frame == WarRiderFrames[7]) {

            waraxe (self.enemy, '3.00000 3.00000 82.00000', 1.00000);
         } else {

            if (self.movechain.frame == WarRiderFrames[8]) {
         ...
         if ( (self.rider_gallop_mode == 1.00000) ) {
            ...
            self.movechain.frame = WarRiderFrames[14] + (self.frame - war_start[self.rider_gallop_mode]);
            if (self.movechain.frame == WarRiderFrames[15]) {

               waraxe (self.enemy, '3.00000 3.00000 82.00000', 1.00000);
            } else {

               if (self.movechain.frame == WarRiderFrames[16]) {

                  waraxe (self.enemy, '-3.00000 3.00000 70.00000', 1.00000);
               } else {

                  if (self.movechain.frame == WarRiderFrames[17]) {
            ...
            if ( (self.rider_gallop_mode == 2.00000) ) {
               ...
               self.movechain.frame = WarRiderFrames[18] + (self.frame - war_start[self.rider_gallop_mode]);
               if (self.movechain.frame == WarRiderFrames[19]) {

                  waraxe (self.enemy, '3.00000 3.00000 82.00000', 1.00000);
               } else {

                  if (self.movechain.frame == WarRiderFrames[20]) {

                     waraxe (self.enemy, '2.00000 3.00000 78.00000', 1.00000);
                  } else {

                     if (self.movechain.frame == WarRiderFrames[21]) {

                        waraxe (self.enemy, '0.00000 3.00000 74.00000', 1.00000);
                     } else {

                        if (self.movechain.frame == WarRiderFrames[22]) {
