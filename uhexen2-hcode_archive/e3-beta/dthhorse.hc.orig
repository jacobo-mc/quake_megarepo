...
local float retval = 0.00000;
   ...
   if ( (self.monster_stage == DH_STAGE_ATTACK) ) {
      ...
      if ( (self.rider_gallop_mode == 0.00000) ) {
         ...
         self.movechain.frame = ((DeathRiderFrames->1.00000) + (self.frame - (death_start->self.rider_gallop_mode)));
         if ( (self.movechain.frame == (DeathRiderFrames->2.00000)) ) {

            waraxe (self.enemy, '3.00000 3.00000 82.00000', 1.00000);
         } else {

            if ( (self.movechain.frame == (DeathRiderFrames->3.00000)) ) {
